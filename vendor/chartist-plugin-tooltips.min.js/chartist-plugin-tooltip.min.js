        ...
        c.plugins.tooltip = function(j) {
            ...
            function(i) {
                ...
                function l(b) {
                    p = p || o.offsetHeight,
                    q = q || o.offsetWidth;
                    var c, d, e = -q / 2 + j.tooltipOffset.x, f = -p + j.tooltipOffset.y;
                    if (j.appendToBody)
                        ...
                        !0 === j.anchorToPoint && b.target.x2 && b.target.y2 && (c = parseInt(b.target.x2.baseVal.value),
                ...
                o || (o = b.createElement("div"),
                o.className = j.class ? "chartist-tooltip " + j.class : "chartist-tooltip",
                ...
                k("mouseover", m, function(a) {
                    ...
                    if (j.transformTooltipTextFnc && "function" == typeof j.transformTooltipTextFnc && (s = j.transformTooltipTextFnc(s)),
                    j.tooltipFnc && "function" == typeof j.tooltipFnc)
                        ...
                        if (n = '<span class="chartist-tooltip-meta">' + n + "</span>",
                        r)
                            f += n + "<br>";
                        ...
                        s && (j.currency && (s = void 0 != j.currencyFormatCallback ? j.currencyFormatCallback(s, j) : j.currency + s.replace(/(\d)(?=(\d{3})+(?:\.\d+)?$)/g, "$1,")),
